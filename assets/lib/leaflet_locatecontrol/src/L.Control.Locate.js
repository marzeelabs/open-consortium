    ...
    onAdd: function (map) {
        ...
        var visualizeLocation = function() {
            ...
            if (self._locateOnNextLocationFound) {
                // Peter: commenting default behavior
                // self._map.fitBounds(self._event.bounds);

                // Peter: added higher zoom level so we don't go straight to city level
                self._map.setView(self._event.latlng, 10);
                // self._map.panInsideBounds(self._event.bounds);
                // self._map.panTo(self._event.latlng);
